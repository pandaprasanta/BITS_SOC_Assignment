...
<div id="main">
 <header>
   ...
   <nav>
      ...
      <li class="active"><a href="http://localhost:1010/Spring3HibernateIntegration/pro" id="prof">Profile</a></li>
...
<h2>About Pratian</h2>
Pratian is a leading provider of Information Technology
training and consulting services and is dedicated to
facilitating the skill development needs of its customers.
Pratian's objective is to provide exceptional IT training
and consulting services at competitive prices that are in
line with your business objectives.
Pratian currently offers expert training services in the 
following areas:<br>
1. Java and Java EE<br>
2. Dot net<br>
3. OOA, OOD, UML, Design Patterns<br>
4. SAP
